...
description: "Compare the codebase with a Spec Kit feature's spec, plan, and tasks, then append remaining work to tasks.md. Use after implementation to make the task list converge on the required outcome."
---
