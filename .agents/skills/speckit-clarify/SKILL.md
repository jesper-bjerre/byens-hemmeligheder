...
description: "Clarify underspecified areas in the current Spec Kit feature by asking up to five targeted questions and writing the answers into spec.md. Use before planning when requirements are ambiguous."
---
...
Context for prioritization: the invocation text
