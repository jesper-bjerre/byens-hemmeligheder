...
description: "Convert the current Spec Kit feature's tasks into actionable, dependency-ordered GitHub issues. Use only when the user wants existing tasks published as issues."
---
