...
- [ ] T010 Document purpose, legal basis, access and deletion deadline for each personal-data field
- [ ] T011 Add negative authorization, revocation and deletion/retention tests for personal data
